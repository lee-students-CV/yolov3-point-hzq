...
# hyp = {
#     'giou': 8.32,  # giou loss gain
#     'cls': 6.16,  # cls loss gain
#     'cls_pw': 1.0,  # cls BCELoss positive_weight
#     'obj': 97.8,  #64.35,#1,#49.5,  # obj loss gain (*=img_size/320 if img_size != 320)
#     'obj_pw': 1.0,  # obj BCELoss positive_weight
#     'iou_t': 0.241,  # iou training threshold
#     'lr0': 0.0058,  # initial learning rate (SGD=1E-3, Adam=9E-5)
#     'lrf': -4.,  # final LambdaLR learning rate = lr0 * (10 ** lrf)
#     'momentum': 0.88,  # SGD momentum
#     'weight_decay': 0.000327,  # optimizer weight decay
#     'fl_gamma': 0.5,  #0.5,  # focal loss gamma
#     'hsv_h': 0.0137,  # image HSV-Hue augmentation (fraction)
#     'hsv_s': 0.461,  # image HSV-Saturation augmentation (fraction)
#     'hsv_v': 0.503,  # image HSV-Value augmentation (fraction)
#     'degrees': 4.04,  # image rotation (+/- deg)
#     'translate': 0.0549,  # image translation (+/- fraction)
#     'scale': 0.0479,  # image scale (+/- gain)
#     'shear': 0.543
# }
    ...
    for epoch in range(start_epoch - 1 if opt.prebias else start_epoch,
        ...
        if opt.prebias:
            ...
            results, maps = test.test(
                ...
                iou_thres=0.8 if final_epoch and is_coco else 0.8,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data',
                        type=str,
                        default='D:\HZQ\jtrafficsigns\yolov3-point\data\CCTSDB.data',
                        help='*.data path')
