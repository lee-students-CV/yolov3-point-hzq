...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str,
                        default='cfg/yolov3-tiny-cbam.cfg', help='*.cfg path')
    parser.add_argument('--names', type=str,
                        default='data/CCTSDB.names', help='*.names path')
    parser.add_argument('--weights', type=str,
                        default='D:\HZQ\jtrafficsigns\yolov3-point\训练的数据\yolov3-tiny-cbam\yolov3-tiny-cbam_weights/best.pt', help='path to weights file')
    # input file/folder, 0 for webcam
    parser.add_argument('--source', type=str,
                        default='D:\HZQ\jtrafficsigns\yolov3-point/video\shitang.mp4', help='source')
